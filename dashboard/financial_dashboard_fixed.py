...
def create_filters(df):
    ...
    # 持续时间筛选
    duration_min = int(df['duration_hours'].min())
    duration_max = int(df['duration_hours'].max())
    ...
    # 价格变化筛选
    price_min = float(df['price_change_pct'].min())
    price_max = float(df['price_change_pct'].max())
